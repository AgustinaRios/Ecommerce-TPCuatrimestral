...
<head runat="server">
    <link href="EstilosVinilos.css" rel="stylesheet" />
...
<body>
   ...
   <h4>Ingrese su Cuenta</h4> 
    ...
    <asp:TextBox ID="TxtPass" class="controls" type="password" placeholder="Ingrese su Contraseña" aria-label="Ingrese Nombre" runat="server"></asp:TextBox>
     <asp:Button ID="BtnAgregar" Text="ENTRAR" onclick="BtnAgregar_Click" runat="server"  CssClass="btn-outline-primary" />
    <p><a class="btn-outline-primary" href="RegistrarCuenta.aspx">Registrarme</a></p>
 </div>
        </div>
    </form>
</body>
