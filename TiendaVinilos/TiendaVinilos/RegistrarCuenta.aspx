        ...
        <div class="container-Formularios">
             ...
             <div class="row"> 
              ...
              <div class="row"> 
               ...
               <div class="col">
                   <asp:TextBox ID="TxtPass" class="controls" MaxLength="8" type="password" placeholder="Tu password deber ser entre 8 y 20 caracteres." aria-label="Ingrese Nombre" runat="server"></asp:TextBox>
                </div>
                    </div>
