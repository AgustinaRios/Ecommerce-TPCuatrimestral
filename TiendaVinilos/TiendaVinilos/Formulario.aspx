        ...
        <div class="CuerpoRegistro">
            ...
            <div class="FormularioRegistro">
                ...
                <div>    
                    ...
                    <asp:TextBox ID="TxtArtista" class="controls" type="text"  placeholder="Ingrese el Artista"  runat="server"></asp:TextBox>                                      
                    ...
                    <asp:Label ID="LblGenero" runat="server" Text="Genero" Font-Size="Medium"></asp:Label>
                    <asp:DropDownList runat="server" ID="ddlGenero" CssClass="form-control">
                    </asp:DropDownList>
                    <div>
                    <asp:Label ID="LblCategoria" runat="server" Text="Categoria" Font-Size="Medium"></asp:Label>
                ...
                <updatepanel>
                    <contentemplate>
                       ...
                       <asp:Button ID="BtnAceptar" Text="Aceptar" OnClick="BtnAceptar_Click" runat="server" CssClass="btn btn-primary" ToolTip="Click para loguerte" />
                        ...
                        </div> <asp:RangeValidator ID="rvclass" runat="server" ControlToValidate="TxtPrecio"
